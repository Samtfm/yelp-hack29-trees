class Node{
    ...
    parentDistance(){
        return this.distance(this.parentNode);
    }
}
...
function colonization(scaffolding, startNode, startDist, scaling, noise, captureFraction, minBranchLength){
    ...
    while(counter < 1000){ //Hard cutoff on tree size.
        ...
        var branchLength = connectingNode.parentNode === null ?
                            startDist :
                            Math.max(connectingNode.parentDistance() * scaling * (1 + noise*randn_bm()), minBranchLength);
